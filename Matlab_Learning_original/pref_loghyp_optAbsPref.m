function [f, df] = pref_loghyp_optAbsPref(loghyp, x, prefs, fPrior, ridge, siga)
...
[fmap, ~, GammaMap] = nr_plgp_wPrior_AbsPref(fdummy, prefs, Sigma, sigp, fPrior, siga);
